...
NanoPlot -t 8 --fastq /path/to/my/Project/all_input_reads/fastq_pass/barcode02/*.fastq.gz --maxlength 40000 --plots dot --N50 -o /path/to/my/Project/nanoplot_output_stats/barcode02_pass_nanoplot

# run nanoplot on all of the barcode02 fail data
NanoPlot -t 8 --fastq /path/to/my/Project/all_input_reads/fastq_fail/barcode02/*.fastq.gz --maxlength 40000 --plots dot --N50 -o /path/to/my/Project/nanoplot_output_stats/barcode02_fail_nanoplot

# run nanoplot on the combined barcode02 fail pass data
NanoPlot -t 8 --fastq /path/to/my/Project/longread_mergedfiles/barcode02/longread_failpass_merger.fastq.gz --maxlength 40000 --plots dot --N50 -o /path/to/my/Project/nanoplot_output_stats/barcode02_failpass_nanoplot
