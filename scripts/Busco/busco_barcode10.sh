#!/bin/bash
#SBATCH --job-name=busco_barcode10
...
# make a directory to put all of our barcode10 assemblies into 
mkdir /path/to/my/Project/barcode10_assemblies_fasta

# copy all fasta files to the input assemblies directory 
# moving all barcode10 unicyler output
cp /path/to/my/Project/unicycler_all_output/unicycler_barcode10*.fasta /path/to/my/Project/barcode10_assemblies_fasta

# moving all barcode10 miniasm output
cp /path/to/my/Project/miniasm_utgassem_results/miniasm_barcode10*.fasta /path/to/my/Project/barcode10_assemblies_fasta


# run busco on all assemblies we have so far
for ASSEMBLYFILE in /path/to/my/Project/barcode10_assemblies_fasta/*
do
