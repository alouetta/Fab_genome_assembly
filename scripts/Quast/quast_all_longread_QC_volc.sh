...
-g /path/to/your/Project/haloferax_volcanii/ncbi_dataset/data/GCF_000025685.1/genomic.gff /path/to/your/Project/miniasm_utgassem_results/*.fasta /path/to/your/Project/unicycler_all_output/unicycler_*/*assembly.fasta  
