...
-g /path/to/your/Project/quast_all_assembly_output_med_and_volc/volc_med_combined.gff /path/to/your/Project/miniasm_utgassem_results/*.fasta /path/to/your/Project/unicycler_all_output/unicycler_*/*assembly.fasta  
